...
function YourAccesories({
  ...
  const nftsText = {
    Orb: "<p>Only <strong>1000 Orbs</strong> available on a price curve <strong>increasing 0.2%</strong> with each new mint.</p><p>Each Orb has a <strong>random color</strong>!</p>",
    TruthSphere:
